...
#include "/home/liam/friotaioch/src/qt/intro.h"
...
static constexpr auto qt_meta_stringdata_ZN5IntroE = QtMocHelpers::stringData(
    "Intro",
    "requestCheck",
    "",
    "setStatus",
...
Q_CONSTINIT static const uint qt_meta_data_ZN5IntroE[] = {
...
Q_CONSTINIT const QMetaObject Intro::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN5IntroE.offsetsAndSizes,
    qt_meta_data_ZN5IntroE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN5IntroE_t,
        // Q_OBJECT / Q_GADGET
...
void Intro::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (Intro::*)();
            if (_q_method_type _q_method = &Intro::requestCheck; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
void *Intro::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN5IntroE.stringdata0))
