...
#include "/home/liam/friotaioch/src/qt/modaloverlay.h"
...
namespace {
struct qt_meta_tag_ZN12ModalOverlayE_t {};
} // unnamed namespace


#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN12ModalOverlayE = QtMocHelpers::stringData(
    "ModalOverlay",
    "triggered",
    "",
    "hidden",
...
Q_CONSTINIT static const uint qt_meta_data_ZN12ModalOverlayE[] = {
...
Q_CONSTINIT const QMetaObject ModalOverlay::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN12ModalOverlayE.offsetsAndSizes,
    qt_meta_data_ZN12ModalOverlayE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN12ModalOverlayE_t,
        // Q_OBJECT / Q_GADGET
...
void ModalOverlay::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->triggered((*reinterpret_cast< std::add_pointer_t<bool>>(_a[1]))); break;
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (ModalOverlay::*)(bool );
            if (_q_method_type _q_method = &ModalOverlay::triggered; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
void *ModalOverlay::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN12ModalOverlayE.stringdata0))
