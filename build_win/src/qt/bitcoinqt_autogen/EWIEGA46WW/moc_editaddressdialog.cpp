...
#include "/home/liam/friotaioch/src/qt/editaddressdialog.h"
...
namespace {
struct qt_meta_tag_ZN17EditAddressDialogE_t {};
} // unnamed namespace


#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN17EditAddressDialogE = QtMocHelpers::stringData(
    "EditAddressDialog",
    "accept",
    ""
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN17EditAddressDialogE[] = {
...
Q_CONSTINIT const QMetaObject EditAddressDialog::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN17EditAddressDialogE.offsetsAndSizes,
    qt_meta_data_ZN17EditAddressDialogE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN17EditAddressDialogE_t,
        // Q_OBJECT / Q_GADGET
...
void *EditAddressDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN17EditAddressDialogE.stringdata0))
