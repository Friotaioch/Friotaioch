...
#include "/home/liam/friotaioch/src/qt/addressbookpage.h"
...
static constexpr auto qt_meta_stringdata_ZN15AddressBookPageE = QtMocHelpers::stringData(
    "AddressBookPage",
    "sendCoins",
    "",
    "addr",
...
Q_CONSTINIT static const uint qt_meta_data_ZN15AddressBookPageE[] = {
...
Q_CONSTINIT const QMetaObject AddressBookPage::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN15AddressBookPageE.offsetsAndSizes,
    qt_meta_data_ZN15AddressBookPageE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN15AddressBookPageE_t,
        // Q_OBJECT / Q_GADGET
...
void AddressBookPage::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (AddressBookPage::*)(QString );
            if (_q_method_type _q_method = &AddressBookPage::sendCoins; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
void *AddressBookPage::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN15AddressBookPageE.stringdata0))
