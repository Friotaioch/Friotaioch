...
#include "/home/liam/friotaioch/src/qt/askpassphrasedialog.h"
...
static constexpr auto qt_meta_stringdata_ZN19AskPassphraseDialogE = QtMocHelpers::stringData(
    "AskPassphraseDialog",
    "textChanged",
    "",
...
Q_CONSTINIT static const uint qt_meta_data_ZN19AskPassphraseDialogE[] = {
...
Q_CONSTINIT const QMetaObject AskPassphraseDialog::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN19AskPassphraseDialogE.offsetsAndSizes,
    qt_meta_data_ZN19AskPassphraseDialogE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN19AskPassphraseDialogE_t,
        // Q_OBJECT / Q_GADGET
...
void AskPassphraseDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->toggleShowPassword((*reinterpret_cast< std::add_pointer_t<bool>>(_a[1]))); break;
        default: ;
        }
    }
}
...
void *AskPassphraseDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN19AskPassphraseDialogE.stringdata0))
