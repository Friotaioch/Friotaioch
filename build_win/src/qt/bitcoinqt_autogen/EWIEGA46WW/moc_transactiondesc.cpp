...
#include "/home/liam/friotaioch/src/qt/transactiondesc.h"
...
static constexpr auto qt_meta_stringdata_ZN15TransactionDescE = QtMocHelpers::stringData(
    "TransactionDesc"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN15TransactionDescE[] = {
...
Q_CONSTINIT const QMetaObject TransactionDesc::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN15TransactionDescE.offsetsAndSizes,
    qt_meta_data_ZN15TransactionDescE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN15TransactionDescE_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<TransactionDesc, std::true_type>
    >,
    nullptr
} };
...
void *TransactionDesc::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN15TransactionDescE.stringdata0))
