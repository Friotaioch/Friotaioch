...
#include "/home/liam/friotaioch/src/qt/overviewpage.h"
...
static constexpr auto qt_meta_stringdata_ZN12OverviewPageE = QtMocHelpers::stringData(
    "OverviewPage",
    "transactionClicked",
    "",
    "QModelIndex",
...
Q_CONSTINIT static const uint qt_meta_data_ZN12OverviewPageE[] = {
...
Q_CONSTINIT const QMetaObject OverviewPage::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN12OverviewPageE.offsetsAndSizes,
    qt_meta_data_ZN12OverviewPageE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN12OverviewPageE_t,
        // Q_OBJECT / Q_GADGET
...
void OverviewPage::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->setBalance((*reinterpret_cast< std::add_pointer_t<interfaces::WalletBalances>>(_a[1]))); break;
        ...
        case 6: _t->handleTransactionClicked((*reinterpret_cast< std::add_pointer_t<QModelIndex>>(_a[1]))); break;
        case 7: _t->updateAlerts((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1]))); break;
        case 8: _t->setMonospacedFont((*reinterpret_cast< std::add_pointer_t<QFont>>(_a[1]))); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (OverviewPage::*)(const QModelIndex & );
            if (_q_method_type _q_method = &OverviewPage::transactionClicked; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _q_method_type = void (OverviewPage::*)();
            if (_q_method_type _q_method = &OverviewPage::outOfSyncWarningClicked; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
...
void *OverviewPage::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN12OverviewPageE.stringdata0))
