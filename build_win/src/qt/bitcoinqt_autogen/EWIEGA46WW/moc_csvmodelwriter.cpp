...
#include "/home/liam/friotaioch/src/qt/csvmodelwriter.h"
...
static constexpr auto qt_meta_stringdata_ZN14CSVModelWriterE = QtMocHelpers::stringData(
    "CSVModelWriter"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN14CSVModelWriterE[] = {
...
Q_CONSTINIT const QMetaObject CSVModelWriter::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN14CSVModelWriterE.offsetsAndSizes,
    qt_meta_data_ZN14CSVModelWriterE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN14CSVModelWriterE_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<CSVModelWriter, std::true_type>
    >,
    nullptr
} };
...
void *CSVModelWriter::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN14CSVModelWriterE.stringdata0))
