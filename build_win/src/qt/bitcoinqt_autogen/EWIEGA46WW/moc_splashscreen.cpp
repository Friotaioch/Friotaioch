...
#include "/home/liam/friotaioch/src/qt/splashscreen.h"
...
static constexpr auto qt_meta_stringdata_ZN12SplashScreenE = QtMocHelpers::stringData(
    "SplashScreen",
    "showMessage",
    "",
    "message",
...
Q_CONSTINIT static const uint qt_meta_data_ZN12SplashScreenE[] = {
...
Q_CONSTINIT const QMetaObject SplashScreen::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN12SplashScreenE.offsetsAndSizes,
    qt_meta_data_ZN12SplashScreenE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN12SplashScreenE_t,
        // Q_OBJECT / Q_GADGET
...
void SplashScreen::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->showMessage((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<int>>(_a[2])),(*reinterpret_cast< std::add_pointer_t<QColor>>(_a[3]))); break;
...
void *SplashScreen::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN12SplashScreenE.stringdata0))
