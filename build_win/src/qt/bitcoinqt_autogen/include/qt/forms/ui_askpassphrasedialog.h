...
public:
    ...
    void setupUi(QDialog *AskPassphraseDialog)
    {
        ...
        passLabel2->setObjectName("passLabel2");
        ...
        toggleShowPasswordButton->setObjectName("toggleShowPasswordButton");
    ...
    void retranslateUi(QDialog *AskPassphraseDialog)
    {
        ...
        toggleShowPasswordButton->setText(QCoreApplication::translate("AskPassphraseDialog", "Show passphrase", nullptr));
