...
public:
    ...
    void setupUi(QDialog *PSBTOperationsDialog)
    {
        if (PSBTOperationsDialog->objectName().isEmpty())
            PSBTOperationsDialog->setObjectName("PSBTOperationsDialog");
        ...
        transactionDescription->setObjectName("transactionDescription");
        ...
        signTransactionButton->setObjectName("signTransactionButton");
        ...
        broadcastTransactionButton->setObjectName("broadcastTransactionButton");
