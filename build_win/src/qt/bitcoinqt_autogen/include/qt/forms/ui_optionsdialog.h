...
public:
    ...
    void setupUi(QDialog *OptionsDialog)
    {
        ...
        horizontalSpacer_0_Main = new QSpacerItem(40, 5, QSizePolicy::Policy::Expanding, QSizePolicy::Policy::Minimum);

        verticalLayout_Main->addItem(horizontalSpacer_0_Main);

        horizontalLayout_Main_Prune = new QHBoxLayout();
        horizontalLayout_Main_Prune->setObjectName("horizontalLayout_Main_Prune");
        prune = new QCheckBox(tabMain);
        prune->setObjectName("prune");

        horizontalLayout_Main_Prune->addWidget(prune);

        pruneSize = new QSpinBox(tabMain);
        pruneSize->setObjectName("pruneSize");

        horizontalLayout_Main_Prune->addWidget(pruneSize);

        pruneSizeUnitLabel = new QLabel(tabMain);
        pruneSizeUnitLabel->setObjectName("pruneSizeUnitLabel");
        pruneSizeUnitLabel->setTextFormat(Qt::PlainText);

        horizontalLayout_Main_Prune->addWidget(pruneSizeUnitLabel);

        horizontalSpacer_Main_Prune = new QSpacerItem(40, 20, QSizePolicy::Policy::Expanding, QSizePolicy::Policy::Minimum);
        ...
        pruneWarning->setObjectName("pruneWarning");
        ...
        horizontalSpacer_2_Main = new QSpacerItem(40, 20, QSizePolicy::Policy::Expanding, QSizePolicy::Policy::Minimum);
        ...
        horizontalLayout_Main_VerifyLabel->setObjectName("horizontalLayout_Main_VerifyLabel");
        ...
        horizontalSpacer_Main_Threads = new QSpacerItem(40, 40, QSizePolicy::Policy::Expanding, QSizePolicy::Policy::Minimum);
        ...
        enableServer->setObjectName("enableServer");
        ...
        subFeeFromAmount->setObjectName("subFeeFromAmount");
        ...
        m_enable_psbt_controls->setObjectName("m_enable_psbt_controls");
        ...
        groupBoxHww->setObjectName("groupBoxHww");
        verticalLayoutHww = new QVBoxLayout(groupBoxHww);
        verticalLayoutHww->setObjectName("verticalLayoutHww");
        horizontalLayoutHww = new QHBoxLayout();
        horizontalLayoutHww->setObjectName("horizontalLayoutHww");
        externalSignerPathLabel = new QLabel(groupBoxHww);
        externalSignerPathLabel->setObjectName("externalSignerPathLabel");

        horizontalLayoutHww->addWidget(externalSignerPathLabel);

        externalSignerPath = new QLineEdit(groupBoxHww);
        externalSignerPath->setObjectName("externalSignerPath");
        ...
        verticalSpacer_Wallet = new QSpacerItem(20, 40, QSizePolicy::Policy::Minimum, QSizePolicy::Policy::Expanding);
        ...
        mapPortNatpmp->setObjectName("mapPortNatpmp");
        ...
        horizontalSpacer_1_Network = new QSpacerItem(40, 20, QSizePolicy::Policy::Expanding, QSizePolicy::Policy::Minimum);
        ...
        horizontalSpacer_2_Network = new QSpacerItem(40, 20, QSizePolicy::Policy::Expanding, QSizePolicy::Policy::Minimum);
        ...
        horizontalSpacer_4_Network = new QSpacerItem(40, 20, QSizePolicy::Policy::Expanding, QSizePolicy::Policy::Minimum);
        ...
        showTrayIcon->setObjectName("showTrayIcon");
        ...
        moneyFontLabel->setObjectName("moneyFontLabel");

        horizontalLayout_4_Display->addWidget(moneyFontLabel);

        moneyFont = new QComboBox(tabDisplay);
        moneyFont->setObjectName("moneyFont");

        horizontalLayout_4_Display->addWidget(moneyFont);

        moneyFont_preview = new QLabel(tabDisplay);
        moneyFont_preview->setObjectName("moneyFont_preview");
        moneyFont_preview->setText(QString::fromUtf8("111.11111111 BTC\n"
"909.09090909 BTC"));
        ...
        horizontalSpacer_Bottom = new QSpacerItem(40, 20, QSizePolicy::Policy::Expanding, QSizePolicy::Policy::Minimum);
        ...
        openBitcoinConfButton->setObjectName("openBitcoinConfButton");
...
#if QT_CONFIG(tooltip)
        databaseCacheLabel->setToolTip(QCoreApplication::translate("OptionsDialog", "Maximum database cache size. Make sure you have enough RAM. A larger cache can contribute to faster sync, after which the benefit is less pronounced for most use cases. Lowering the cache size will reduce memory usage. Unused mempool memory is shared for this cache.", nullptr));
#endif // QT_CONFIG(tooltip)
...
#if QT_CONFIG(tooltip)
        mapPortNatpmp->setToolTip(QCoreApplication::translate("OptionsDialog", "Automatically open the Bitcoin client port on the router. This only works when your router supports PCP or NAT-PMP and it is enabled. The external port could be random.", nullptr));
#endif // QT_CONFIG(tooltip)
        mapPortNatpmp->setText(QCoreApplication::translate("OptionsDialog", "Map port using PCP or NA&T-PMP", nullptr));
#if QT_CONFIG(tooltip)
...
#if QT_CONFIG(tooltip)
        connectSocks->setToolTip(QCoreApplication::translate("OptionsDialog", "Connect to the Bitcoin network through a SOCKS5 proxy.", nullptr));
#endif // QT_CONFIG(tooltip)
