...
public:
    ...
    void setupUi(QDialog *ReceiveCoinsDialog)
    {
        ...
        QIcon icon;
        icon.addFile(QString::fromUtf8(":/icons/receiving_addresses"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        ...
        addressType->setObjectName("addressType");
        ...
        QIcon icon2;
        icon2.addFile(QString::fromUtf8(":/icons/eye"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
