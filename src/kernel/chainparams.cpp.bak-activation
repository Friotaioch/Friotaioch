...
{
    // Genesis coinbase - Thomas Clarke, signatory of the 1916 Irish Proclamation.
    // Full statement (May 1916): "I and my fellow signatories believe that we have
    // struck the first successful blow for Freedom. The next blow... will win through.
    // In this belief we die happy." On-chain coinbase trimmed to the 100-byte cap.
    const char* pszTimestamp = "Thomas Clarke 1916 - the next blow will win through. In this belief we die happy";
...
public:
    CMainParams(const MainNetOptions& opts) {
        ...
        consensus.nMinimumChainWork = uint256{}; // FRIO: fresh chain, no assumed work
        consensus.defaultAssumeValid = uint256{}; // FRIO: validate all from genesis
        ...
        genesis = CreateGenesisBlock(1786453747, 2174250354, 0x1d00ffff, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256{"000000002c96c2fb439dafed60fa09a3bbcbbdcbe0fd9567e31d89b6f860a62a"});
        assert(genesis.hashMerkleRoot == uint256{"20fb53afbdad5ee45d73fdfadf4b854dad920cf3a63eb07fec0dcfbb414568d6"});
        ...
        m_assumeutxo_data = {}; // FRIO: no inherited snapshots

        chainTxData = ChainTxData{
            // FRIO: fresh chain, values from genesis.
            .nTime    = 1786453747,
            .tx_count = 0,
            .dTxRate  = 0,
        };
...
public:
    CTestNetParams(const TestNetOptions& opts) {
        ...
        consensus.nMinimumChainWork = uint256{}; // FRIO testnet
        consensus.defaultAssumeValid = uint256{}; // FRIO testnet
        ...
        genesis = CreateGenesisBlock(1786453748, 801811600, 0x1d00ffff, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256{"00000000934190a95c9dc4387570a47afd32f2f120c9192769b31928080b755d"});
        assert(genesis.hashMerkleRoot == uint256{"20fb53afbdad5ee45d73fdfadf4b854dad920cf3a63eb07fec0dcfbb414568d6"});
...
public:
    CTestNet4Params(const TestNetOptions& opts) {
        ...
        consensus.nMinimumChainWork = uint256{}; // FRIO
        consensus.defaultAssumeValid = uint256{}; // FRIO
...
public:
    explicit SigNetParams(const SigNetOptions& options)
    {
        ...
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256{"3d4debda1b3424c5d1ff9cf0f162b8a9ccbccba5c1f18ba9fade4d8cafd24d6d"});
        assert(genesis.hashMerkleRoot == uint256{"20fb53afbdad5ee45d73fdfadf4b854dad920cf3a63eb07fec0dcfbb414568d6"});
...
public:
    explicit CRegTestParams(const RegTestOptions& opts)
    {
        ...
        genesis = CreateGenesisBlock(1786453750, 2, 0x207fffff, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256{"38b15f7ba7a8d94cb2bc0dfe497c5b71c8058af4611f08e04d5e91dd1ba59141"});
        assert(genesis.hashMerkleRoot == uint256{"20fb53afbdad5ee45d73fdfadf4b854dad920cf3a63eb07fec0dcfbb414568d6"});
