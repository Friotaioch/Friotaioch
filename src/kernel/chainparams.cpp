...
public:
    CMainParams(const MainNetOptions& opts) {
        ...
        m_assumed_chain_state_size = 14;
                ...
                genesis = CreateGenesisBlock(1787076029, 1929576519, 0x1d00ffff, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256{"00000000908e647ce8296582a2d24023ef96a5e7d2320a5815b603463993676d"});
