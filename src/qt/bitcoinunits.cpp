...
{
    switch (unit) {
    case Unit::BTC: return QString("FRIO");
    case Unit::mBTC: return QString("mFRIO");
    case Unit::uBTC: return QString::fromUtf8("µFRIO");
...
{
    switch (unit) {
    case Unit::BTC: return QString("Friotaioch");
    case Unit::mBTC: return QString("Milli-Friotaioch (1 / 1" THIN_SP_UTF8 "000)");
    case Unit::uBTC: return QString("Micro-Friotaioch (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
