...
void ReceiveCoinsDialog::setModel(WalletModel *_model)
{
    ...
    if(_model && _model->getOptionsModel())
    {
        ...
        {
            // FRIO post-quantum (P2QRH) address types. Sentinel data 1000/1001 (not OutputType).
            int idx1 = ui->addressType->count();
            ui->addressType->addItem(tr("P2QRH \u00b7 ML-DSA (quantum-resistant)"), 1000);
            ...
            ui->addressType->addItem(tr("P2QRH \u00b7 SPHINCS+ (quantum-resistant)"), 1001);
