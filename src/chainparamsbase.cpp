...
std::unique_ptr<CBaseChainParams> CreateBaseChainParams(const ChainType chain)
{
    switch (chain) {
    case ChainType::MAIN:
        return std::make_unique<CBaseChainParams>("", 51777);
    case ChainType::TESTNET:
        return std::make_unique<CBaseChainParams>("testnet3", 61777);
    case ChainType::TESTNET4:
        return std::make_unique<CBaseChainParams>("testnet4", 49332);
    case ChainType::SIGNET:
        return std::make_unique<CBaseChainParams>("signet", 41777);
